...
<template>
  <div>
    <div class="service_c">
      <div>以下水果鲜花在{{ buda.community }}范围内免费送货上门，订购时付款，不满意可以换货，也可以退款。</div>
      <div>下午订购，次日上午8点前送达；上午订购，当天下午4点前送达；您还可以指定送货时间，我们将在您指定的时间内送货。</div>
      <div>订购/客服微信：TobeBuda（订购暂时通过微信联系，我们将在一周内完成本页面的订购功能。）</div>
    </div>
    <div class="grid_c">
