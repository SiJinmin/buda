...
scp D:\buda\c\https.c root@tool.idealand.xyz:/buda/c/
*/
...
#define SSLCertPath "/etc/letsencrypt/live/idealand.space/fullchain.pem"
#define SSLKeyPath "/etc/letsencrypt/live/idealand.space/privkey.pem"
...
int main(int argc, char** argv)
{
  ...
  ctx = initSSL(SSLCertPath, SSLKeyPath); if (ctx == NULL) {  perror("init ssl fail."); return 0; }

  sock = create_socket_listen(ListenPort);
